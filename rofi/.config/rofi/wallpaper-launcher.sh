...
TRANSITIONS=("wipe" "top" "left" "right" "bottom" "outer" "center" "simple")
TRANSITION=${TRANSITIONS[$RANDOM % ${#TRANSITIONS[@]}]}
swww img ${wall_dir}/${wall_selection} --transition-fps 120 --transition-type "$TRANSITION"
